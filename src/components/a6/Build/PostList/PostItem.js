            ...
            <li class="list-group-item">
                <div class="wd-box-border-bookmark0 wd-padding-bookmark-ABCD">
                    ...
                    <div class="wd-author-handle-bookmark">
                        ...
                        <div
                            class="wd-box-border-image-bookmark wd-rounded-bookmark wd-margin-top-bookmark">
                            <img class="wd-rounded-bookmark1" height="264px" src={posts.img2}
                                 width="504px"/>
                            <span
                                class="wd-padding-bookmark wd-bold-white-bookmark">{posts.content2}</span><br/>
                            <span
                                class="wd-padding-bookmark wd-lightgray15-bookmark">{posts.content3}</span>
                        </div>
                    </div>
                </div>
                <div class="wd-box-border-bookmark1 wd-flex-bookmark">
                    ...
                    <a href="#">
                        <i class="wd-lightgray15-bookmark fas fa-upload"/>
                    </a>
                </div>
            </li>
        </>
